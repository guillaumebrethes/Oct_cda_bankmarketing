...
with st.expander(label="Affichage des recomendations metier", expanded=False):
    st.markdown("""
            <ul>
                ...
                <li>La variable <span class="orange-bold">campaign</span> indique l'importance cruciale du premier contact, soulignant que les efforts doivent être concentrés pour maximiser les chances de souscription dès cette première interaction.</li><br>
                <li>Par ailleurs, la planification des campagnes devrait être évitée les mois de <span class="orange-bold">Mai, Juillet et Août</span>, où une diminution de l'efficacité des campagnes est observée, vraisemblablement due aux vacances.</li><br>
...
with st.expander(label="Affichage de conclusion", expanded=False):
    ...
    <ul>
        ...
        <li>A l'avenir, l'entreprise pourra s'appuyer sur ces modèles optimisés pour affiner encore davantage ses stratégies de ciblage.</li><br>
